...
# TODO: test changes. What about multiple nonlinear constraints --> Ausprobieren
def constraints_as_scipy_constraints(
    ...
    for c in problem.constraints:
        if isinstance(c, opti.LinearEquality):
            ...
            fun = ConstraintWrapper(constraint=c, problem=problem, n_experiments=n_experiments, tol=tol)
